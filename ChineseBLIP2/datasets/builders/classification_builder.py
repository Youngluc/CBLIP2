...
from ChineseBLIP2.datasets.datasets.nlvr_datasets import NLVRDataset, NLVREvalDataset
from ChineseBLIP2.datasets.datasets.snli_ve_datasets import SNLIVisualEntialmentDataset
