...
from ChineseBLIP2.datasets.datasets.image_text_pair_datasets import ImageTextPairDataset
from ChineseBLIP2.datasets.datasets.laion_dataset import LaionDataset
