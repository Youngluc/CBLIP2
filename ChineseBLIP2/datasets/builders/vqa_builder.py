...
from ChineseBLIP2.datasets.builders.base_dataset_builder import BaseDatasetBuilder

from ChineseBLIP2.common.registry import registry
from ChineseBLIP2.datasets.datasets.aok_vqa_datasets import AOKVQADataset, AOKVQAEvalDataset
from ChineseBLIP2.datasets.datasets.coco_vqa_datasets import COCOVQADataset, COCOVQAEvalDataset
from ChineseBLIP2.datasets.datasets.vg_vqa_datasets import VGVQADataset
from ChineseBLIP2.datasets.datasets.gqa_datasets import GQADataset, GQAEvalDataset
