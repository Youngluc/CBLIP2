...
from ChineseBLIP2.models.albef_models.albef_outputs import AlbefOutputFeatures
...
class AlbefFeatureExtractor(AlbefBase):
    ...
    def extract_features(self, samples, mode="multimodal"):
        ...
        Returns:
            An AlbefOutputFeatures object, see ChineseBLIP2/models/albef_models/albef_outputs.py for details.
