...
from ChineseBLIP2.common.utils import get_abs_path, is_url
from ChineseBLIP2.models.albef_models import AlbefBase
from ChineseBLIP2.models.albef_models.albef_outputs import AlbefIntermediateOutput, AlbefOutput
from ChineseBLIP2.models.base_model import MomentumDistilationMixin, tile
from ChineseBLIP2.models.med import BertConfig, BertLMHeadModel, XBertEncoder
from ChineseBLIP2.models.vit import VisionTransformerEncoder, interpolate_pos_embed
...
class AlbefVQA(AlbefBase, MomentumDistilationMixin):
    ...
    def forward(self, samples):
        ...
        Returns:
            ...
            see ChineseBLIP2/models/albef_models/albef_outputs.py for more details.
    ...
    def predict_answers(self, samples, answer_list, num_ans_candidates=128, **kwargs):
        ...
        Examples:
            ...
            >>> from ChineseBLIP2.models import load_model_and_preprocess
