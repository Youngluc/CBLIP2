...
from ChineseBLIP2.models.base_model import MomentumDistilationMixin, SharedQueueMixin
from ChineseBLIP2.models.blip_models import tie_encoder_decoder_weights
from ChineseBLIP2.models.blip_models.blip import BlipBase
from ChineseBLIP2.models.blip_models.blip_outputs import (
    BlipOutput,
    BlipSimilarity,
    BlipIntermediateOutput,
)
from ChineseBLIP2.models.med import XBertEncoder, XBertLMHeadDecoder
...
class BlipPretrain(BlipBase, SharedQueueMixin, MomentumDistilationMixin):
    ...
    def forward(self, samples):
        ...
        Returns:
            BlipOutput: A BlipOutput object containing loss and intermediate output. See ``ChineseBLIP2.models.blip_models.blip_outputs.BlipOutput`` for more details.
