...
from ChineseBLIP2.common.utils import get_abs_path
from ChineseBLIP2.models.base_model import BaseModel
from ChineseBLIP2.models.clip_models.clip_outputs import ClipOutput, ClipOutputFeatures
from ChineseBLIP2.models.clip_models.timm_model import TimmModel
from ChineseBLIP2.models.clip_models.transform import image_transform
from ChineseBLIP2.models.clip_models.utils import freeze_batch_norm_2d
from ChineseBLIP2.tasks.multimodal_classification import MultimodalClassificationTask
...
class CLIP(BaseModel):
    ...
    def loss(self):
        if self._loss is None:
            from ChineseBLIP2.models.clip_models.loss import ClipLoss
    ...
    def zero_shot_predict(self, image_path, categories):
        ...
        from ChineseBLIP2.processors.clip_processors import ClipImageEvalProcessor
